    ...
    <div className="min-h-screen pb-20">
      ...
      <section className="relative bg-gradient-to-b from-primary/5 to-background pt-20 pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/8 rounded-full blur-3xl animate-float-slow opacity-40" />
          <div className="absolute top-1/2 right-0 w-80 h-80 bg-accent/8 rounded-full blur-3xl animate-float-delayed opacity-30" />
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <motion.h1 
              ...
              className="text-5xl sm:text-6xl font-display font-black text-foreground leading-tight"
            >
              Buy & Sell on <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Campus</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
